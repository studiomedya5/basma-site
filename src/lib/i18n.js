...
export const STR = {
  fr: {
    ...
    your_info: "Vos coordonnées", subtotal: "Sous-total",
    cod_hint: "Paiement à la livraison · Nous vous appelons pour confirmer",
    ...
    promo_code: "Code promo", promo_placeholder: "Code promo …",
    promo_apply: "Appliquer", promo_invalid: "Code invalide", promo_expired: "Code expiré",
    promo_free_ship: "✓ Livraison gratuite appliquée 🎉", promo_used: "Ce code a déjà été utilisé avec ce numéro",
  ...
  ar: {
    ...
    your_info: "معلوماتك", subtotal: "المجموع الفرعي",
    cod_hint: "الدفع عند الاستلام · نتصل بك للتأكيد",
    ...
    promo_apply: "تطبيق", promo_invalid: "كود غير صالح", promo_expired: "انتهت صلاحية الكود",
    promo_free_ship: "✓ تم تطبيق التوصيل المجاني 🎉", promo_used: "هذا الكود مستعمل سابقًا بنفس الرقم",
